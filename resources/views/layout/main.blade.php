...
<head>
    ...
    <link href="/laravel54/public/css/blog.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="/laravel54/public/css/wangEditor.min.css">
...
<div class="blog-masthead">
    <div class="container">
        <ul class="nav navbar-nav navbar-left">
            <li>
                <a class="blog-nav-item " href="/laravel54/public/posts">首页</a>
            </li>
            <li>
                <a class="blog-nav-item" href="/laravel54/public/posts/create">写文章</a>
            </li>
            <li>
            ...
            <li class="dropdown">
                <div>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="../public/logout">登出</a></li>
                    </ul>
                </div>
            </li>
        </ul>
...
<script type="text/javascript" src="/laravel54/public/js/wangEditor.min.js"></script>
<script src="/laravel54/public/js/ylaravel.js"></script>
